    ...
    _steps.prototype = {
        ...
        render: function(){ // 渲染样式
            ...
            options.data.forEach(function(currentValue, index, array){
                ...
                var stepLineBox = '<div class="step-line-box" style="' + lineStyle + 'order:' + lineIndex + '"><div class="step-line {{finishLineClass}}"><div class="proBar"></div></div><div class="step-icon ' + stepIconClass + '"><div class="' + stepIconInnerClass + '">' + stepIconInnerText + '</div></div></div>';
