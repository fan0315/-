define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        // searchList: {"0":__('Status 1'),"1":__('Status 2')}, formatter: Table.api.formatter.status
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'service/index/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
