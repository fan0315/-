...
use app\common\model\EmployeeAccount;
...
class Auth
{
    ...
    public function staff_login($username, $password)
    {
        ...
        $user = EmployeeAccount::get([$field => $username]);
     ...
     * @return boolean
     */
    public function staff_direct($user_id)
    {
        $user = EmployeeAccount::get($user_id);
...
//                $user->prevtime = $user->logintime;
    ...
    //验证更改状态
    public function staff_save($data = []){
        $res = EmployeeAccount::update($data);
