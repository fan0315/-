...
class Index extends Backend
{
    ...
    /**
     * Index模型对象
     * @var \app\admin\model\product\Index
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\product\Index;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            foreach ($list as $row) {
                $row->visible(['id','category_id','name','image','weigh','createtime']);
                $row->visible(['procategory']);
				$row->getRelation('procategory')->visible(['id','name']);
            }
